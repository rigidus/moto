                 ...
                 (frm
                  (tbl
                   (list
                    ...
                    (row "Метро" (fld "area-living"))
                    (row "Название жк" (fld "area-kitchen"))
                    (row "Кол-во комнат" (fld "price"))
                    (row "Срок сдачи (не позднее)" (fld "balcon"))
                    (row "Стоимость квартиры" (fld "sanuzel"))
                    (row "" %find%))
                   :border 1))))
