...
** Страница списка вакансий
   ...
   Она опирается на javascript-функцию tggl, которая определена в файле ~b.js~:
   ...
   Здесь нам не хватает функций, которые формируют html-предаставления вакансий. Вот
   они:
