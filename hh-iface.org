...
** Страница списка вакансий
   ...
   #+BEGIN_SRC lisp
         ...
         (html-page
          `(,@(legend)
              ...
              ("div" (("class" "row no-gutters"))
                     ,@(apply #'vac-col (vac-elt-list-block uninteresting-vacs "uninteresting"))
                     ;; ,@(apply #'vac-col (vac-elt-list-block unsort-vacs "unsort"))
                     ,@(vac-col "col-unsort" "unsort"  (vac-elt-list unsort-vacs "unsort"))
     ...
     (let* ((vacs (aif (all-vacancy) it (err "null vacancy")))
       ...
       (print
        ;; (apply #'vac-col (vac-elt-list-block unsort-vacs "unsort"))))
        (vac-elt-list-block unsort-vacs "unsort")))
