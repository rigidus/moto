        ...
        (tree-to-html
         `(("html"
            ...
            ("body"
             ...
             ("script" (("type" "text/javascript") ("src" "/js/jquery-v-1.10.2.js")))
             ("script" (("type" "text/javascript") ("src" "/js/jquery-ui-v-1.10.3.js")))
             ("script" (("type" "text/javascript") ("src" "/js/modernizr.js")))
             ("script" (("type" "text/javascript") ("src" "/js/jquery.sortable.original.js")))
             ("script" (("type" "text/javascript") ("src" "/js/frp.js")))
             ...
             ("div"
              ...
              ,@(legend)
              ("button"
               (("type" "button") ("class" "btn btn-primary btn-graph")
                ("onclick" "tggl('graph', 'graph', '.graph', '.btn-graph');"))
               "graph")
              ("div" (("class" "graph") ("style" "text-align: center; overflow: auto;"))
                     ("img" (("src" "/img/vacancy-state.png"))))
              ("button"
               (("type" "button") ("class" "btn btn-primary btn-uninteresting")
                ("onclick"
                 "tggl('uninteresting', 'uninteresting', '.col-uninteresting', '.btn-uninteresting');"))
               "uninteresting")
              ("button"
               (("type" "button") ("class" "btn btn-primary btn-unsort")
                ("onclick" "tggl('unsort', 'unsort', '.col-unsort', '.btn-unsort');"))
               "unsort")
              ("button"
               (("type" "button") ("class" "btn btn-primary btn-interesting")
                ("onclick"
                 "tggl('unsort', 'unsort', '.col-interesting', '.btn-interesting');"))
               "interesting")
              ("div"
               (("class" "row no-gutters"))
               ("div"
                (("class" "col col-uninteresting"))
                ("div"
                 (("style" "text-align: center")) "uninteresting")
                ("ul"
                 (("class" "connected handles list no2") ("id" "yep"))
                 ("li"
                  (("id" "22616610") ("class" "unsort") ("title" "") ("draggable" "true")
                   ("style" "display: list-item;"))
                  ("span" (("class" "emptynotes")) "NIL0")
                  ("a" (("href" "/hh/vac/22616610")) "Специалист по продажам (Amazon)"))))
               ("div"
                (("class" "col col-unsort"))
                ("div"
                 (("style" "text-align: center")) "unsort")
                ("ul"
                 (("class" "connected handles list") ("id" "not"))
                 ("li"
                  (("id" "22604660") ("class" "unsort") ("title" "NULL")
                   ("draggable" "true") ("style" "display: list-item;"))
                  ("span" (("class" "notes")) "NILNULL") "
                         "
                  ("a" (("href" "/hh/vac/22604660")) "Team Lead C++/QT"))))
               ("div"
                (("class" "col col-interesting"))
                ("div"
                 (("style" "text-align: center")) "uninteresting")
                ("ul"
                 (("class" "connected handles list no2") ("id" "yep"))
                 ("li"
                  (("id" "22616610") ("class" "unsort") ("title" "") ("draggable" "true")
                   ("style" "display: list-item;"))
                  ("span"
                   (("class" "emptynotes")) "NIL0")
                  ("a"
                   (("href" "/hh/vac/22616610"))
