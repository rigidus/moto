...
** Поле ввода
   ...
   #+BEGIN_SRC lisp
     ...
     (defmacro input ((name title &rest rest &key class required type value &allow-other-keys) &body validator-error)
       (let ((label `(:label :for ,name)))
         ...
         (let ((result-class "form-element input-text"))
           ...
           (let ((input `(:input :type ,type :name ,name :id ,name :class ,result-class :value ,value)))
             ...
             (let ((input-container `((:div :class "input-container")
                                      (,label ,title)
                                      (,input))))
             ...
             <div class="main hasNavigation ">
                 ...
                 <article class="content">
                     ...
                     <div class="content-box size-3-5 switch-content-container">
                         ...
                         {$test | noAutoescape}
                         <form action="#" method="post" name="regform" class="form-section-container js__formValidation" id="regform_on_regpage">
                             <input type="hidden" name="csrf_registration" id="csrf_registration" value="d34d75644abf8f1f0b9ee7bbaeb8c178-61d7aa05b65801c3185523a93438a225" />
                             <h2 class="form-headline heading__headline--h2">Регистрационные данные</h2>
                             <div class="form-section">
                                 <fieldset>
                                     <legend>Обязательные поля</legend>
                                     <div class="input-container">
                                         <label for="register-mail">Email<span class="required-marker">*</span></label>
                                         <input name="register-mail"
                                                required="required"
                                                class="form-element input-text required"
                                                maxlength="50"
                                                id="register-mail"
                                                value=""
                                                type="email" />
                                     ...
                                     <div class="input-container">
                                         <label for="register-password">Password<span class="required-marker">*</span></label>
                                     ...
                                     <div class="input-container">
                                         <label for="register-password-confirm">Repeat password<span class="required-marker">*</span></label>
                                         <input name="register-password-confirm"
                                                required="required"
                                                class="form-element input-text required"
                                                autocomplete="off"
                                     ...
                                     <div class="input-container">
                                         <label for="register-nickname">Никнейм<span class="required-marker">*</span></label>
                                         <input class="form-element input-text"
                                                name="nickname"
                                                required="required"
                                                maxlength="25"
                                                id="nickname"
                             ...
                             <div class="form-section">
                                 <fieldset>
                                     <legend>Необязательные поля</legend>
                                     <div class="input-container">
                                         <label for="register-nickname">Имя</label>
                                         <input class="form-element input-text"
                                                name="firstname"
                                                maxlength="25"
                                                id="firstname"
                                     ...
                                     <div class="input-container">
                                         <label for="register-nickname">Фамилия</label>
                                         <input class="form-element input-text"
                                                name="lastname"
                                                maxlength="25"
                                                id="lastname"
                                     ...
                                     <div class="input-container input-container--1-2 odd">
                                         <p class="validation-explanation validation-explanation--static hidden">
                                             Номер телефона неверный или неполный
                                         </p>
                                         <label for="customer-data-fieldset-telephone">Телефон</label>
                                         <input class="form-element input-text"
                                                name="telephone"
                                                id="telephone"
                                                maxlength="15"
                                     ...
                                     <div class="input-container input-container--1-2 even">
                                         <p class="validation-explanation validation-explanation--static hidden">
                                             Номер телефона неверный или неполный
                                         </p>
                                     ...
                                     <div class="input-container" id="salutation-container">
                                         <label for="salutation-select">Пол<span class="required-marker">*</span></label>
                                         <select size="1"
                                                 name="customer-data[customer-address-fieldset][salutation]"
                                                 class="form-element js__switchContent js__toggleDisabledState"
                                                 id="salutation-select"
                                                 data-switch="sizes-select,sizes-select">
                                             <option value="" label="Please select" data-switch-target="missing-salutation"
                                             data-disable="garment-size-jacket,garment-size-trousers">Выбрать пол</option>
                                             <option value="Мужской" label="Mr" data-switch-target="m">Мужской</option>
                                             <option value="Женский" label="Ms" data-switch-target="f">Женский</option>
                                         </select>
                                     </div>
                                     <div class="date-container">
                                         <label for="date_of_birth">День рождения</label>
                                         <div class="date-container__inputs fieldset-validation">
                                             <div class="hide-label input-container input-container--1st">
                                                 <p class="validation-explanation validation-explanation--static hidden">
                                                     Пожалуйста введите
                                                     день в формтате: XX
                                                 </p>
                                             <label class="hidden" for="date_of_birth_day">DD</label>
                                             <input maxlength="2"
                                             ...
                                             <div class="hide-label input-container input-container--2nd input-container--middle">
                                                 <p class="validation-explanation validation-explanation--static hidden">
                                                     Пожалуйста введите
                                                     месяц в формтате: XX
                                                 </p>
                                                 <label class="hidden" for="date_of_birth_month">MM</label>
                                                 <input maxlength="2"
                                             ...
                                             <div class="hide-label input-container input-container--3rd">
                                                 <p class="validation-explanation validation-explanation--static hidden">
                                                     Пожалуйста введите
                                                     год в формтате: XXXX
                                                 </p>
                                                 <label class="hidden" for="date_of_birth_year">YYYY</label>
                                                 <input maxlength="4"
                             ...
                             <div class="form-send-container">
                                 <button name="mylouis-customer-data-submit" type="submit" class="button" value="Jetzt registrieren">Зарегистрироваться</button>
                             </div>
