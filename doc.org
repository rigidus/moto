...
** DONE Задачи (task)
   ...
   #+results: task_state_graph
   : new -> inaction [label ="starttask"];
   : inaction -> standby [label ="stoptask"];
   : standby -> inaction [label ="restarttask"];
   : new -> cancelled [label ="cancelnewtask"];
   : inaction -> cancelled [label ="cancelactiontask"];
   : standby -> cancelled [label ="cancelstandbytask"];
   : inaction -> terminated [label ="terminateactiontask"];
   : standby -> terminated [label ="terminatestandbytask"];
