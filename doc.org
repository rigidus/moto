...
** Квартира (flat)
   ...
   #+NAME: flat_data
     ...
     | area-sum     | integer    | общая площадь квартиры                 |
     | area-living  | integer    | жилая площадь квартиры                 |
     | area-kitchen | integer    | площадь кухни                          |
     | price        | integer    | цена                                   |
     | subsidy      | boolean    | субсидия                               |
     | finishing    | boolean    | отделка                                |
     | ipoteka      | boolean    | ипотека                                |
     | installment  | boolean    | рассрочка                              |
     | balcony      | varchar    | балкон/лоджия                          |
