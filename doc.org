...
** DONE Жилые комплексы (cmpx)
   ...
   #+NAME: cmpx_flds
     | field         | field type             | note                                                                 |
     |---------------+------------------------+----------------------------------------------------------------------|
     | id            | serial                 | Идентификатор в виде GUID-а                                          |
     ...
     | subway2Id     | (or db-null integer)   | Идентификатор ближайшено метро №1 reftbl:subway                      |
     | subway3Id     | (or db-null integer)   | Идентификатор ближайшено метро №1 reftbl:subway                      |
