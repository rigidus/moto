...
* Язык описания резюме
  ...
  #+BEGIN_SRC lisp
    ...
    - Спроектировал и разработал интернет-магазин (три версии за полтора года"))
                         :about "
    На самом деле я не настоящий ИТ-директор :) По большей части я высококвалифицированный программист, который \"программирует процесс своего программирования\" и любит решать сложные задачи. Однако я обнаружил, что существует много людей, которые готовы платить мне за побочные продукты этого процесса, а также за то, что я использую свои наработки для организации своего (и не своего) труда. Оказывается, что мой опыт решения задач приносит им неплохую прибыль: я просто знаю что (не) сработает и почему.

    Внутри процесса разработки ПО эффективность может возрастать по мере вовлечения в него других людей, поэтому небольшие команды (или группы небольших комманд) могут быть чудовищно эффективны, особенно если их снабдить удобными инструментами. Моя квалификация позволяет писать такое инструменты под задачи, или применять уже существующие, но без фанатизма: не применяя то, что не работает. И что особенно важно - избегая инструментов, которые ограничивают то, как мы можем думать о задачах.

    Я также помню, что коммуникация в команде - это самая дорогая штука. Именно она ограничивает рост эффективных команд. Поэтому команду из трех-четырех высококвалифицированных людей, не может догнать любое количество \"середнячков\". Проблема лишь в том, чтобы найти и нанять таких специалистов. Обычный найм (через headhunter) гораздо менее эффективен, чем направленный поиск среди знакомых в сообществах, но для того чтобы пользоваться доверием в сообществе нужно обладать определенной квалификацией. Да и ни один специалист не хочет работать с кем-то кто менее квалифицирован чем он - это просто потеря времени, потому что слабый партнер не может научить.

    Поэтому я весьма озабочен тем, чтобы быть возможно более сильным с точки зрения навыков и компетенций. Это прямой путь к уважению коллег, а уважение в сообществе программистов означает работу \"на совесть\" не просто потому что им платят деньги. Высококвалифицироанные программисты зарабатывают достаточно, чтобы денежная мотивация не была решающей.

    Но в большинстве случаев команда вообще не нужна. В индустрии по-настоящему много вещей, которые могут быть в короткий срок разработаны одним высококвалифицированным программистом. Тем не менее надо этими задачами работают целые отделы, а иногда даже и крупные фирмы. Это происходит по двум причинам. Одна из них - владелец проекта минимизирует bus-фактор (риск провала в случае если один из разработчиков будет сбит автобусом). Вторая же - типично организационная проблема, суть которой в том, что каждый начальник более заинтересован в росте количества своих подчиненных, т.к. это показатель его влияния. Как человек, который в одиночку разрабатывал CMS, CRM, интернет-магазины, распределенные платежные системы, внутренний документооборот и даже embedded software я могу утверждать это с большой уверенностью.

    Умею:
    - программировать в одиночку и управлять командой
    - нанимать технических специалистов
    - отвечать за результат
    - формализовывать бизнес-процессы
    - обучать разработчиков
    - следить за качеством кода
    - распределять нагрузку на людей
    - укладываться в сроки

    Разрабатываю все, что автоматизирует бизнес и помогает зарабатывать деньги:
    - интернет-магазины,
    - ПО для железа,
    - распределенные платежные системы,
    - внутренний документооборот,
    - CRM и ERP.

    Интегрирую все это с 1С, SAP, картографическими сервисами, биллингами и другими внешними системами через протоколы взаимодействия и API

    Умею \"думать вперед\", формализовывать требования и предвидеть возможные будущие проблемы.

    Умею планировать архитектуру проекта, учитывая возможное масштабирование в будущем в т.ч. под высокие нагрузки.

    Постоянный докладчик семинаров по функциональному программированию в Санкт-Петербурге (https://plus.google.com/communities/106931692847918217517) и IT Global Meetup (http://piter-united.ru/). Исследую современные подходы в области \"искусственного интеллекта\", нейросетей и machine learning.
