  ...
  #+BEGIN_SRC lisp
                ...
                (send-post-multiple-values
                    (section-url
                     ...
                     (append
                      ...
                      `(("skills.string"  . ,(url-enc (getf plist :skills-string))))
                      `(("_xsrf"                          . ,(cdr (assoc "_xsrf" cookie-alist :test #'equal))))))
    ...
    (let ((cookie-jar (make-instance 'drakma:cookie-jar)))
      ...
      (hh-post-resume cookie-jar
                      ...
                      :expiriences `((:name "AIS"
                                            :company-id ""
                                            :company-area-id "2"
                                            :url "http://aintsys.com"
                                            :industry-id ""
                                            :industries nil
                                            :id ""
                                     ...
                                     (:name "WizardSoft"
                                            :company-id ""
                                            :company-area-id "2"
                                            :url "http://wizardsoft.ru"
                                            :industry-id ""
                                            :industries nil
                                            :position "Ведущий разработчик, архитектор"
                                            :start-date "2009-09-01"
                                            :end-date "2011-04-01"
                                            :description "Разработка высоконагрузочного портала для проведения строительных тендеров. Прототип реализован на Common Lisp, Postmodern и PostgreSQL, был переписан на PHP+Jquery по кадровым соображениям.")
                                     (:name "ЦиFры"
                                            :company-id ""
                                            :company-area-id "2"
                                     ...
                                     (:name "ООО Вебдом"
                                            ...
                                            :end-date "2007-01-01"
                                            :description "Cпроектировал и разработал масштабируемый фреймворк, на котором теперь работает компания. CMS на его основе поставляется клиентам.")
                                     (:name "Почин"
                                            :company-id ""
                                            :company-area-id "2"
                                            :url "http://pochin.ru"
                      ...
                      :contacts `(:cell-phone "+79112869290"
                                              :cell-phone-comment "С 9 до 5"
                                              :home-phone "+78127410289"
                                              :home-phone-comment "ночью не звонить"
                                              :work-phone "+78129932323"
                                              :work-phone-comment "по рабочим вопросам"
