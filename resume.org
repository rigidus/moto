...
* COMMENT Язык описания резюме
  ...
  #+BEGIN_SRC lisp
    ...
    Стек технологий: PHP, MySql, Jquery, Common Lisp, Memcached")
                      ...
                      :about "
    Умею программировать в одиночку и управлять командой, нанимать технических специалистов, отвечать за результат, формализовывать бизнес-процессы, обучать разработчиков, следить за качеством кода и распределять нагрузку на людей.

    Разрабатываю все, что автоматизирует бизнес и помогает зарабатывать деньги: интернет-магазины, ПО для железа, распределенные платежные системы, внутренний документооборот, CRM, ERP. Интегрирую все это с 1С, SAP, картографическими сервисами и биллингами.

    Умею \"думать вперед\", формализовывать требования и предвидеть возможные будущие проблемы. Умею планировать архитектуру проекта, учитывая возможное масштабирование в будущем в т.ч. под высокие нагрузки.

    Специализируюсь на сложных проектах с неопределенными техническими требованиями (\"безнадежные\" проекты).

    Постоянный докладчик семинаров по функциональному программированию в Санкт-Петербурге (https://plus.google.com/communities/106931692847918217517) и IT Global Meetup (http://piter-united.ru/)

    Используемые технологии:

    Linux, FreeBSD

    PHP, Python, C/C++, Java, Common Lisp, Erlang
