...
(define-automat vacancy "Автомат вакансии"
  ...
  (:accept :offer :waitoffer :discard :interview :invite :reject :beenviewed :responded :interesting :uninteresting :unsort)
  ((:unsort :uninteresting :uns-uni)
   ...
   (:interview :waitoffer :int-wai)
   (:waitoffer :offer :wai-off)
   (:waitoffer :discard :wai-dis)
   (:waitoffer :uninteresting :wai-ini)
   (:waitoffer :waitoffer :wai-wai)
