...
(define-automat vacancy "Автомат вакансии"
  ...
  (:offer :wait_result :refuse_applicant :refuse_employer :send_test :run_test :skype_interview :interview :wait_test :wait_skype_interview :wait_interview :called :favorited :responded :hidden :viewed :new :interested :not_interested :teaser)
  ((:teaser :not_interested :teaser-rejection)
   (:teaser :interested :rejection-favorite)
   (:teaser :new :parsing)
   (:new :viewed :view)
   (:viewed :new :renew)
