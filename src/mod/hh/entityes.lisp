...
(define-automat vacancy "Автомат вакансии"
  ((id serial)
   ...
   (emptype (or db-null varchar))
   (workhours (or db-null varchar))
   (skills (or db-null varchar))
   (datetime (or db-null varchar))
   (date-text (or db-null varchar))
   (responsibility (or db-null varchar))
   (requirement (or db-null varchar))
   (addr (or db-null varchar))
   (street-addr (or db-null varchar)))
  (id)
  ()
  ()
  ...
  ((:unsort :uninteresting :uns-uni)
   ...
   (:unsort :beenviewed :uns-bee)
   (:unsort :reject :uns-rej)
   (:unsort :invite :uns-inv)
...
(define-automat resume "Автомат резюме"
  ((id serial)
   ...
   (personal-site (or db-null varchar))
