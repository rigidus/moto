...
10	login-user	login	Пользователь #1 : admin вошел в систему	1	3632978383
11	logout-user	logout	Пользователь #1 : admin вышел из системы	1	3632978395
12	login-user-fail	login-fail	Неудачная попытка входа	0	3632979244
13	login-user-success	login-success	Пользователь #6 : Aeternitas вошел в систему	6	3632993292
14	login-user-success	login-success	Пользователь #6 : Aeternitas вошел в систему	6	3632994623
15	login-user-success	login-success	Пользователь #1 : admin вошел в систему	1	3632997356
16	login-user-success	login-success	Пользователь #1 : admin вошел в систему	1	3633007524
17	login-user-success	login-success	Пользователь #6 : Aeternitas вошел в систему	6	3633012534
18	login-user-success	login-success	Пользователь #6 : Aeternitas вошел в систему	6	3633019775
19	login-user-success	login-success	Пользователь #6 : Aeternitas вошел в систему	6	3633060004
20	login-user-success	login-success	Пользователь #1 : admin вошел в систему	1	3633064207
21	create-msg	create	Пользователь #1 : admin послал сообщение пользователю #6 : Aeternitas	1	3633064499
22	create-msg	create	Пользователь #6 : Aeternitas послал сообщение пользователю #1 : admin	6	3633065942
23	login-user-success	login-success	Пользователь #1 : admin вошел в систему	1	3633072666
...
29	1	6	Я вижу, что у тебя получилось вызвать какую-то ошибку. Как и где это произошло?	3632997398	0	:UNDELIVERED
30	6	1	без понятия... а когда хоть?	3633012735	0	:UNDELIVERED
...
COPY role (id, name, descr) FROM stdin;
1	webuser	Пользователи сайта. Они могут выполнять все пользовательские сценарии, (начиная с "регистрации" и "логина") и использовать все функциональные элементы на страницах сайта. Некоторые из пользователей, имеющих эту роль имеют дополнительные права, например на редактирование групп
2	timebot	Роботы, выполняющие задачи по расписанию. Могут подключаться к таймерам и использовать низкоуровневое API сайта для сбора и обработки данных. Они представляют собой код, который работает прямо внутри системы
3	autotester	Роботы, выполняющие тестирование внешних API сайта. Могу подключаться к таймерам и использовать внешнее REST-API сайта по протоколам взаимодейтствия, определенным для внешних агентов. Они представляют собой код, который работает как сторонняя программа, возможно даже на другой машине
4	agent	Сторонние программы и агенты (такие, как мобильные приложения), которые могут только использовать только внешнее REST-API системы
\.
...
--
-- Name: foreign_role; Type: FK CONSTRAINT; Schema: public; Owner: ylg
--
